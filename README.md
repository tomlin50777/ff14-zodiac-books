...
- 書內與側欄的副本都會顯示進入等級；書內同一地圖的討伐、理符與 FATE 全部完成後，整個地圖區塊會切換為綠色完成狀態。
- 「只顯示未完成」會同步過濾副本、上方 FATE 與下方地圖路線。
- 進入天書後往下捲動，頁面頂端會出現精簡凍結列；保留 3 個副本與 3 個 FATE 的名稱、等級／地點和可同步勾選的進度。
- 同輪必要副本全部完成後才會解鎖「現在先繳交」；四大任務共保留 10 次獨立交付紀錄。
